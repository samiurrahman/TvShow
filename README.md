# Tv Show Application
This is open TV shows application that allows users to view list of all TV shows and their all details. this application usage API from "tvmaz" http://www.tvmaze.com/. 
